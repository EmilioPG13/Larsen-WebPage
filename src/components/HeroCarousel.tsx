              ...
              <div className="lg:col-span-2 p-8 lg:p-12 flex flex-col justify-center bg-gradient-to-br from-gray-50 to-white">
                ...
                <div className="space-y-4">
                  ...
                  <button
                    ...
                    className="w-full bg-larsen-red text-white font-semibold px-8 py-4 rounded-full transition-all duration-300 shadow-lg hover:shadow-2xl hover:brightness-110 hover:scale-[1.02] active:scale-[0.98] transform-gpu group relative overflow-hidden text-lg"
                  >
