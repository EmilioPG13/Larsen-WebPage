...
const QuoteSteps: React.FC = () => {
  const steps = [
    ...
    },
    {
      number: 3,
      title: "Propuesta",
      description: "Recibe una cotización detallada y personalizada",
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      number: 4,
      title: "Entrega",
      description: "Coordinamos la entrega e instalación",
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
            Proceso de <span className="text-larsen-red">Cotización</span>
          </h2>
